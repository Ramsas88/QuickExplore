...
#> 1        x 100       0 0.07   0.09 1.05 -2.61 -0.36 0.62 2.76
#> 2        y 100       0 0.52   0.55 0.31  0.02  0.22 0.77 0.98
compute_numeric_summary(df, c("x", "y"), group_var = "g")
#> # A tibble: 4 × 11
#>   g     Variable     N Missing  Mean Median    SD   Min    Q1    Q3   Max
#>   <chr> <chr>    <int>   <int> <dbl>  <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
#> 1 A     x           50       0  0.02   0.15  1.12 -2.61 -0.54  0.72  2.07
#> 2 B     x           50       0  0.12  -0.01  0.99 -1.91 -0.27  0.57  2.76
#> 3 A     y           50       0  0.5    0.53  0.29  0.04  0.22  0.72  0.98
#> 4 B     y           50       0  0.54   0.61  0.32  0.02  0.22  0.78  0.98
```
